...
const convertAllEscapes = (str) => {
  var result = convertUnicode2Char(str);
  result = convertZeroX2Char(result);
  result = convertHexNCR2Char(result);
  result = convertDecNCR2Char(result);
  result = convertjEsc2Char(result, false);
  result = convertCSS2Char(result, false);
  result = convertpEnc2Char(result);
  result = convertEntities2Char(result);
  
  return result;
}
exports.convertAllEscapes = convertAllEscapes;

var tmp = '{"name_exact": [{ "id":"nm2988909", "title":"", "name":"Ashlee Thompson","description":"Actress, Winter&#x27;s Bone"}],"name_approx": [{ "id":"nm4743957", "title":"", "name":"Ashley Nikkole Thompson","description":"Actress, Rampart"},{ "id":"nm3051736", "title":"", "name":"Ashley Thompson","description":"Music Department, My Father the Hero"},{ "id":"nm0859871", "title":"", "name":"Ashley Cie Thompson","description":"Actress, Hoodlum"},{ "id":"nm1838758", "title":"", "name":"Ashley Thompson","description":"Actress, Pyrrhic Victory"},{ "id":"nm3065382", "title":"", "name":"Ashley Thompson","description":"Actress, Sister Act 2: Back in the Habit"},{ "id":"nm0859870", "title":"", "name":"Ashley Thompson","description":"Actress, Perfect Little Angel"},{ "id":"nm2385849", "title":"", "name":"Ashley Thompson","description":"Make-Up Department, The CMT Music Awards 2006"},{ "id":"nm8068162", "title":"", "name":"Ashley Thompson","description":"Cinematographer, Talking to Myself"},{ "id":"nm4811015", "title":"", "name":"Caitlin Ashley-Thompson","description":"Actress, BLINDSPoT."},{ "id":"nm7927554", "title":"", "name":"Ashley Thompson","description":"Editor, You&#x27;re So Talented"},{ "id":"nm7529166", "title":"", "name":"Ashlea Thompson","description":"Producer, In the Paint"},{ "id":"nm8480528", "title":"", "name":"Ashley K. Thompson","description":"Make-Up Department, Amish Witches: The True Story of Holmes County"},{ "id":"nm1349488", "title":"", "name":"Ashley Thompson","description":"Miscellaneous Crew, The Key"},{ "id":"nm7927556", "title":"", "name":"Ashley Thompson","description":"Miscellaneous Crew, &#x22;Did I Win?&#x22;"},{ "id":"nm6046551", "title":"", "name":"Ashley Elizabeth Thompson","description":"Actress, When, Where, How?"},{ "id":"nm5087046", "title":"", "name":"Ashley Thompson","description":"Actor, The Messenger"},{ "id":"nm7009447", "title":"", "name":"Ashley Thompson","description":"Miscellaneous Crew, The Muddy Obstacle"},{ "id":"nm4316320", "title":"", "name":"Ashley Thompson","description":"Actress, Flash Mob: Sundance"},{ "id":"nm3642295", "title":"", "name":"Ashley Thompson","description":"Actress, Will and Wallace"}]}';

console.log(convertAllEscapes(tmp));